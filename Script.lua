...
if text == '/start' then  
local url,res = http.request('http://teamASKILD.tk/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_ASKILD ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @ASKILDcli }')   
return false 
end
if Dev_ASKILD(msg) then
...
if not Dev_ASKILD(msg) and not redis:sismember(bot_id..'User:Ban:Pv',msg.sender_user_id_) and not redis:get(bot_id..'Status:Lock:Twasl') then
...
redis:set(bot_id..'GetTexting:DevASKILD'..msg.chat_id_..':'..msg.sender_user_id_,true)
...
redis:del(bot_id..'Texting:DevASKILD')
...
if Dev_ASKILD_User(result.id_) == true then
...
send(msg.chat_id_, msg.id_,'*👥┇ عدد المجموعات الان ← { '..#group..' } مجموعه '..ASKILD..''..taha..'\n🔘┇اصبح عدد المجموعات الان ← { '..sendok..' } مجموعات*\n')   
end
end
end,nil)
end
...
if text == 'رفع النسخه الاحتياطيه' and tonumber(msg.reply_to_message_id_) > 0 and Dev_ASKILD(msg) then   
tdcli_function({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},function(Arg, Data)   
...
if text == 'جلب نسخه احتياطيه' and Dev_ASKILD(msg) or text == 'جلب نسخه الكروبات' and Dev_ASKILD(msg) then
local url,res = http.request('http://teamASKILD.tk/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_ASKILD ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @ASKILDcli }')   
...
if text == ("مسح قائمه العام") and Dev_ASKILD(msg) or text == ("مسح المحظورين عام") and Dev_ASKILD(msg) then
local url,res = http.request('http://teamASKILD.tk/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_ASKILD ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @ASKILDcli }')   
...
redis:del(bot_id.."Removal:User:Groups")
send(msg.chat_id_, msg.id_, "🗑┇تم مسح المحظورين عام من البوت")
elseif text == ("مسح المطورين") and Dev_ASKILD(msg) then
local url,res = http.request('http://teamASKILD.tk/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_ASKILD ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @ASKILDcli }')   
...
elseif text == ("قائمه العام") and Dev_ASKILD(msg) or text == ("المحظورين عام") and Dev_ASKILD(msg) then
local url,res = http.request('http://teamASKILD.tk/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_ASKILD ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @ASKILDcli }')   
...
send(msg.chat_id_, msg.id_, Gban)
elseif text == ("المطورين") and Dev_ASKILD(msg) then
local url,res = http.request('http://teamASKILD.tk/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_ASKILD ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @ASKILDcli }')   
...
elseif text == ("حظر عام") and tonumber(msg.reply_to_message_id_) ~= 0 and Dev_ASKILD(msg) then
local url,res = http.request('http://teamASKILD.tk/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_ASKILD ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @ASKILDcli }')   
...
if Dev_ASKILD_User(result.sender_user_id_) == true then
send(msg.chat_id_, msg.id_, "⚠┇لا تستطيع حظر المطور الاساسي عام")
return false 
end
...
elseif text == ("الغاء العام") and tonumber(msg.reply_to_message_id_) ~= 0 and Dev_ASKILD(msg) then
local url,res = http.request('http://teamASKILD.tk/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_ASKILD ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @ASKILDcli }')   
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
elseif text == ("اضف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and Dev_ASKILD(msg) then
local url,res = http.request('http://teamASKILD.tk/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_ASKILD ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @ASKILDcli }')   
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
elseif text == ("حذف مطور") and tonumber(msg.reply_to_message_id_) ~= 0 and Dev_ASKILD(msg) then
local url,res = http.request('http://teamASKILD.tk/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_ASKILD ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @ASKILDcli }')   
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunctionStatus, nil)
elseif text and text:match("^حظر عام @(.*)$") and Dev_ASKILD(msg) then
local url,res = http.request('http://teamASKILD.tk/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_ASKILD ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @ASKILDcli }')   
...
tdcli_function ({ID = "SearchPublicChat",username_ = text:match("^حظر عام @(.*)$")}, FunctionStatus, nil)
elseif text and text:match("^الغاء العام @(.*)$") and Dev_ASKILD(msg) then
local url,res = http.request('http://teamASKILD.tk/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_ASKILD ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @ASKILDcli }')   
...
tdcli_function ({ID = "SearchPublicChat",username_ = text:match("^الغاء العام @(.*)$") }, FunctionStatus, nil)
elseif text and text:match("^اضف مطور @(.*)$") and Dev_ASKILD(msg) then
local url,res = http.request('http://teamASKILD.tk/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_ASKILD ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @ASKILDcli }')   
...
tdcli_function ({ID = "SearchPublicChat",username_ = text:match("^اضف مطور @(.*)$")}, FunctionStatus, nil)
elseif text and text:match("^حذف مطور @(.*)$") and Dev_ASKILD(msg) then
local url,res = http.request('http://teamASKILD.tk/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_ASKILD ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @ASKILDcli }')   
...
elseif text and text:match("^حظر عام (%d+)$") and Dev_ASKILD(msg) then
local url,res = http.request('http://teamASKILD.tk/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_ASKILD ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @ASKILDcli }')   
...
if Dev_ASKILD_User(text:match("^حظر عام (%d+)$")) == true then
send(msg.chat_id_, msg.id_, "⚠┇لا تستطيع حظر المطور الاساسي عام")
return false 
end
...
elseif text and text:match("^الغاء العام (%d+)$") and Dev_ASKILD(msg) then
local url,res = http.request('http://teamASKILD.tk/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_ASKILD ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @ASKILDcli }')   
...
if text and text:match("^اضف مطور (%d+)$") and Dev_ASKILD(msg) then
local url,res = http.request('http://teamASKILD.tk/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_ASKILD ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @ASKILDcli }')   
...
elseif text and text:match("^حذف مطور (%d+)$") and Dev_ASKILD(msg) then
local url,res = http.request('http://teamASKILD.tk/ch/?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.Info_ASKILD ~= true then
send(msg.chat_id_,msg.id_,'\n📌┇عليك الاشتراك في قناة البوت \n💢┇قناة البوت ← { @ASKILDcli }')   
...
elseif text == "تفعيل المغادره" and Dev_ASKILD(msg) then   
redis:del(bot_id.."Status:Lock:Left"..msg.chat_id_)  
send(msg.chat_id_, msg.id_,"☑┇تم تفعيل مغادرة البوت") 
elseif text == "تعطيل المغادره" and Dev_ASKILD(msg) then  
redis:set(bot_id.."Status:Lock:Left"..msg.chat_id_,true)   
send(msg.chat_id_, msg.id_, "☑┇تم تعطيل مغادرة البوت") 
elseif text == "تفعيل الاذاعه" and Dev_ASKILD(msg) then  
redis:del(bot_id.."Status:Broadcasting:Bot") 
send(msg.chat_id_, msg.id_,"☑┇تم تفعيل الاذاعه \n〽┇الان يمكن للمطورين الاذاعه" ) 
elseif text == "تعطيل الاذاعه" and Dev_ASKILD(msg) then  
redis:set(bot_id.."Status:Broadcasting:Bot",true) 
send(msg.chat_id_, msg.id_,"☑┇تم تعطيل الاذاعه") 
...
elseif text == 'تفعيل البوت الخدمي' and Dev_ASKILD(msg) then  
redis:del(bot_id..'Free:Bot') 
send(msg.chat_id_, msg.id_,'☑┇تم تفعيل البوت الخدمي \n⚡┇الان يمكن الجميع تفعيله') 
elseif text == 'تعطيل البوت الخدمي' and Dev_ASKILD(msg) then  
redis:set(bot_id..'Free:Bot',true) 
send(msg.chat_id_, msg.id_,'☑┇تم تعطيل البوت الخدمي') 
...
elseif text == 'وضع كليشه المطور' and Dev_ASKILD(msg) then
redis:set(bot_id..'GetTexting:DevASKILD'..msg.chat_id_..':'..msg.sender_user_id_,true)
send(msg.chat_id_,msg.id_,'📮┇ ارسل لي الكليشه الان')
...
elseif text == ("مسح ردود المطور") and Dev_ASKILD(msg) then 
...
elseif text == ("ردود المطور") and Dev_ASKILD(msg) then 
local list = redis:smembers(bot_id.."List:Rd:Sudo")
text = "\n📝┇قائمة ردود المطور \n━━━━━━━━━━━━━\n"
for k,v in pairs(list) do
...
send(msg.chat_id_, msg.id_,"["..text.."]")
elseif text == "اضف رد للكل" and Dev_ASKILD(msg) then 
...
elseif text == "حذف رد للكل" and Dev_ASKILD(msg) then 
...
if Dev_ASKILD_User(msg.sender_user_id_) == true then
redis:srem(bot_id.."Developer:Bot", result.id_)
redis:srem(bot_id.."President:Group"..msg.chat_id_,result.id_)
redis:srem(bot_id..'Constructor:Group'..msg.chat_id_, result.id_)
redis:srem(bot_id..'Manager:Group'..msg.chat_id_, result.id_)
...
elseif text == "تغير اسم البوت" and Dev_ASKILD(msg) or text == "تغيير اسم البوت" and Dev_ASKILD(msg) then 
redis:setex(bot_id.."Change:Name:Bot"..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_,"📫┇ ارسل لي الاسم الان ")  
elseif text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and DeveloperBot(msg) then 
if redis:get(bot_id.."Status:Broadcasting:Bot") and not Dev_ASKILD(msg) then 
...
💠┇[Channel Source ،](t.me/ASKILDcli)

💭┇[Annotations Source](t.me/INFO_ASKILD)
...
tdcli_function ({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},reply, nil)
return false
elseif text == "تنظيف المشتركين" and Dev_ASKILD(msg) then
local pv = redis:smembers(bot_id..'Num:User:Pv')  
local sendok = 0
for i = 1, #pv do
tdcli_function({ID='GetChat',chat_id_ = pv[i]},function(arg,dataq)
...
return false
elseif text == "تنظيف الكروبات" and Dev_ASKILD(msg) then
local group = redis:smembers(bot_id..'ChekBotAdd')  
local w = 0
local q = 0
for i = 1, #group do
...
local UserName = (b.username_ or "ASKILDcli")
...
elseif text and text:match("^تعين عدد الاعضاء (%d+)$") and Dev_ASKILD(msg) then
redis:set(bot_id..'Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
send(msg.chat_id_, msg.id_,'*☑┇ تم تعيين عدد اعضاء تفعيل البوت اكثر من : '..text:match("تعين عدد الاعضاء (%d+)$")..' عضو *')
elseif text =='الاحصائيات' and DeveloperBot(msg) then 
send(msg.chat_id_, msg.id_,'*📋┇عدد احصائيات البوت الكامله \n━━━━━━━━━━━━━\n📮┇عدد المجموعات : '..(redis:scard(bot_id..'ChekBotAdd') or 0)..'\n👤┇عدد المشتركين : '..(redis:scard(bot_id..'Num:User:Pv') or 0)..'*')
elseif text == 'المطور' or text == 'مطور' then
local TextingDevASKILD = redis:get(bot_id..'Texting:DevASKILD')
if TextingDevASKILD then 
send(msg.chat_id_, msg.id_,TextingDevASKILD)
else
send(msg.chat_id_, msg.id_,'['..UserName_Dev..']')
end
elseif text == 'حذف كليشه المطور' and Dev_ASKILD(msg) then
redis:del(bot_id..'Texting:DevASKILD')
send(msg.chat_id_, msg.id_,'☑┇ تم حذف كليشه المطور')
end
end
end
return {ASKILD = Script}
